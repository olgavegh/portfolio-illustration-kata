    ...
    return (
        <>
            ...
            <label
                ...
                className={`react-switch-label relative flex items-center justify-between cursor-pointer rounded-full transition duration-500 ${isOn ? 'bg-accent' : 'bg-gray-100'}`}
            >
